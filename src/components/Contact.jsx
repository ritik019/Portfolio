...
const socials = [
  ...
  {
    name: 'Email',
    href: 'mailto:ritikpradhan1000@gmail.com',
    ...
    <section id="contact" className="section-padding relative">
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <p className={`text-[15px] leading-relaxed mb-8 max-w-lg ${isDark ? 'text-zinc-400' : 'text-zinc-500'}`}>
        ...
        <div className={`pt-6 border-t ${isDark ? 'border-zinc-800' : 'border-zinc-200'}`}>
          <p className={`text-[13px] ${isDark ? 'text-zinc-600' : 'text-zinc-400'}`}>
            Designed & built by Sakshyat Pradhan
          </p>
        </div>
      </div>
    </section>
